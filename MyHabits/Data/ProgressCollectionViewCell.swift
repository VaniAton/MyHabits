...
class ProgressCollectionViewCell: UICollectionViewCell {
    ...
    private lazy var motivationProgressProcent: UILabel = {
        ...
        motivationProgressProcent.tag = Int(HabitsStore.shared.todayProgress)
    ...
    func setupConstraintsForProgresView() {
        ...
        NSLayoutConstraint.activate([
            ...
            motivationProgressProcent.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 236),
            motivationProgressProcent.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 10),
            motivationProgressProcent.heightAnchor.constraint(equalToConstant: 18),
            
            progresLabelView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 38),
            progresLabelView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 12),
            progresLabelView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -12),
    ...
    func setup(
        with habit: Habit
            ...
            progresLabelView.setProgress(HabitsStore.shared.todayProgress, animated: true)
        }
}
