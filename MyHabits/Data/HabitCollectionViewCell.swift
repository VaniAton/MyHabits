...
class HabitCollectionViewCell: UICollectionViewCell {
    ...
    private lazy var checkOfHabit: UIView = {
        ...
        checkOfHabit.backgroundColor = UIColor.black.withAlphaComponent(0.6)
        return checkOfHabit
    }()
    ...
    private func setupConstraintsForHabitView() {
        NSLayoutConstraint.activate([
            ...
            nameOfHabit.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            nameOfHabit.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 20),
            nameOfHabit.widthAnchor.constraint(equalToConstant: 220),
            nameOfHabit.heightAnchor.constraint(equalToConstant: 22),
            
            nameTimeOfHabit.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            nameTimeOfHabit.topAnchor.constraint(equalTo: nameOfHabit.bottomAnchor, constant: 4),
            
            countOfHabit.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
            countOfHabit.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: 20),
            countOfHabit.heightAnchor.constraint(equalToConstant: 18),
            countOfHabit.widthAnchor.constraint(equalToConstant: 188),
            
            checkOfHabit.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 46),
            checkOfHabit.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -25),
    ...
    func setup(with Habit: Habit
            ...
            nameTimeOfHabit.text = Habit.dateString
            countOfHabit.isEnabled = Habit.isAlreadyTakenToday
        checkOfHabit.backgroundColor = Habit.color
        }
}
